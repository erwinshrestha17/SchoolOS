...
SchoolOS is a production, **Nepal-first, multi-tenant school-management SaaS** — the daily operating desk for schools (Montessori–Grade 10, with +2/Bachelor's on the roadmap). Guiding principle, every screen: **one screen = one main job.** Every screen answers *Where am I? What needs attention? What can I safely do next?*
