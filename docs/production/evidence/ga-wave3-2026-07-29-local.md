# GA wave3 verification (2026-07-29, local)
...
| api typecheck | PASS |  |
| M4 academics smoke spec | SKIP/FAIL | Error: Process from config.webServer was not able to start. Exit code: 1  undefined /Users/erwin/Projects/SchoolOS/apps/web:  ERR_PNPM_RECURSIVE_EXEC_FIRST_FAIL  Command failed with exit code 1: playwright test academics-phase2a-smoke.spec.ts |
