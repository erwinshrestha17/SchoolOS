...
| Idempotent cash collection probe | PASS | first HTTP 201, replay HTTP 201, paymentId=cba55fc9-0dfc-4f6c-a93c-bebfdc35121f |
...
| Parent sandbox fee payment idempotent | FAIL | first HTTP 404, replay HTTP 404, invoice=FEE-BREAKDOWN-ASAR |
