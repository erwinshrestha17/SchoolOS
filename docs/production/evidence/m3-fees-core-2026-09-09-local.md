...
| Idempotent cash collection probe | FAIL | first HTTP 400, replay HTTP 400, paymentId=missing |
...
| Parent unrelated child fee summary denied | PASS | HTTP 403 |
| Parent payment gateway readiness (sandbox) | FAIL | HTTP 403, sandbox=unknown |
