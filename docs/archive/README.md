...
|---|---|---|
| `design/design-qa.md` | `design-qa.md` | `docs/design/SCHOOLOS_WEB_FRONTEND_DESIGN_PLAN.md`, `docs/design/modules/`, and `docs/project/SCHOOLOS_PRODUCTION_READINESS_AUDIT.md`. |
