    ...
    <div className="space-y-8 p-8 max-w-7xl mx-auto">
      <div>
        ...
        <p className="text-slate-500 mt-1">
          Platform-wide activity trail for security and compliance.
        </p>
      </div>
                ...
                >
                    ...
                    <span
                      className={
                        log.tenantId === 'platform'
                          ? 'text-[var(--color-mod-platform-accent)] font-bold text-xs'
                  ...
                  <TableCell className="text-right">
                    <Button
                      variant="ghost"
                      size="sm"
                      className="h-8 rounded-lg gap-1.5 text-xs text-slate-500 hover:text-[var(--color-mod-platform-accent)]"
                    >
                      View JSON
