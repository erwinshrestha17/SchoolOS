      ...
      definitions={[
        {
          ...
          description:
            'Read-only period, posting, and reconciliation signals. Fee collection operations remain in authorized finance workspaces.',
          metrics: [
            { key: 'openFiscalPeriods', label: 'Open fiscal periods' },
            { key: 'unpostedJournals', label: 'Journals not posted' },
            {
              key: 'unreconciledStatements',
              label: 'Statements not reconciled',
            },
