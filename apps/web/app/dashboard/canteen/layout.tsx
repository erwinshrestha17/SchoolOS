...
const canteenTabs = [
  ...
  {
    label: 'Menu',
    href: '/dashboard/canteen/menu',
    permissions: ['canteen:menu:read'],
  },
  {
    label: 'Meal Plans',
    href: '/dashboard/canteen/meal-plans',
...
const canteenOverflowTabs = [
  ...
  },
  {
    ...
    href: '/dashboard/canteen/controls',
    permissions: ['canteen:controls:read'],
  },
  {
    label: 'Reports',
    href: '/dashboard/canteen/reports',
  ...
  return (
    <DashboardPageShell>
      <ModuleHeader
        ...
        primaryAction={
          access.hasPermission('canteen:pos:read') ? (
            <Link
              href="/dashboard/canteen/pos"
        ...
        secondaryActions={
          access.hasPermission('canteen:serving:read') ? (
            <Link
              href="/dashboard/canteen/serving"
