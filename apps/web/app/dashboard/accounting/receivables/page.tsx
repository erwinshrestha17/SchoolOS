...
export default function AccountingReceivablesPage() {
  return (
    <AccountantDestinationWorkspace
      ...
      description="Review backend-owned student invoices, balances, aging, waivers, allocations, and M3-to-M11 posting state."
      links={[
        { href: '/dashboard/fees/invoices', label: 'Invoice register', description: 'Search the server-paginated student invoice register.' },
