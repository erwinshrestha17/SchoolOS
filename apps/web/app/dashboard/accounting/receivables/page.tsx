      ...
      links={[
        {
          ...
          description: 'Search the student invoice register.',
        },
        {
          href: '/dashboard/fees/ledgers',
          label: 'Student ledgers',
          description:
            'Open one student’s billed, paid, waived, refunded, and outstanding history.',
        },
        {
          href: '/dashboard/fees/adjustments?view=waivers',
          label: 'Discounts & waivers',
          description: 'Review controlled discounts and approved waivers.',
        },
        {
          href: '/dashboard/fees/reports',
          label: 'Receivables reports',
          description: 'Run current fee, collection, and aging reports.',
        },
      ]}
    >
