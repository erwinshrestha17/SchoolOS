      ...
      links={[
        {
          ...
          description:
            'Review approved payroll summaries and accounting posting status.',
        },
        {
          href: '/dashboard/payroll/readiness',
          label: 'Payroll readiness',
          description:
            'Review M7 exceptions before an approved accounting handoff.',
        },
        {
          href: '/dashboard/accounting/source-mappings',
          label: 'Posting mappings',
          description: 'Review M7-to-M11 account mapping health.',
        },
        {
          href: '/dashboard/accounting/reports?report=failed-unposted',
          label: 'Posting failures',
          description:
            'Inspect approved source records not represented in the ledger.',
        },
      ]}
    >
