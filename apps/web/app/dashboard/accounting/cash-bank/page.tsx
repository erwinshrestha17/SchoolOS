      ...
      links={[
        {
          ...
          description:
            'Import, match, review, and finalize bank reconciliation.',
        },
        {
          href: '/dashboard/accounting/reports?report=cash-book',
          label: 'Cash book',
          description: 'Review deterministic cash running balances.',
        },
        {
          href: '/dashboard/accounting/reports?report=bank-book',
          label: 'Bank book',
          description:
            'Review bank-account postings for the selected fiscal context.',
        },
        {
          href: '/dashboard/fees/cashier-close',
          label: 'Cashier closes & deposits',
          description: 'Review daily close, variance, and deposit preparation.',
        },
      ]}
    />
  );
