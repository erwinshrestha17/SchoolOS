      ...
      definitions={[
        {
          ...
          title: 'Academic readiness',
          description:
            'Read-only academic progress and publication readiness from the school database.',
          metrics: [
            ...
            {
              key: 'reportCardPublishBlockers',
              label: 'Report cards not published',
            },
            {
              key: 'pendingReportCardCorrections',
              label: 'Result corrections waiting',
            },
