    ...
    <DashboardPageShell>
      <M1PageHeader
        ...
        primaryAction={
          ...
          >
            <UserPlus className="h-4 w-4" /> Create Application
          </Link>
        }
        secondaryActions={
          <Link href="/dashboard/admissions/new?mode=bulk" className="inline-flex min-h-11 items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-bold text-slate-700 shadow-sm hover:bg-slate-50"><Upload className="h-4 w-4" /> Import Applications</Link>
        }
      />
      <AdmissionsPipeline />
    </DashboardPageShell>
