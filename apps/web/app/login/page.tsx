    ...
    <main className="flex min-h-screen bg-white font-sans">
      <section className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-[var(--color-sidebar-900)] p-12 lg:flex">
        ...
        <div className="relative z-10 max-w-md">
          <div className="mb-6 inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-slate-300">
            Staff & Admin Portal
          </div>
        ...
        <div className="relative z-10 text-sm font-medium text-slate-300">
