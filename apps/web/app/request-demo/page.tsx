        ...
        <div className="space-y-6 lg:sticky lg:top-24">
          <div className="space-y-2">
            ...
            <p className="text-slate-500 text-xs sm:text-sm leading-relaxed">
              Tell us about your school and our team will contact you for
              verification, demo, and guided onboarding.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-slate-200 bg-slate-100/50 p-4 text-[11px] text-slate-600 leading-relaxed font-semibold">
            SchoolOS workspaces are created only after verification, so your
            school starts with the correct academic year, class structure, fee
            setup, roles, and access permissions.
          </div>
          ...
          <div className="space-y-4 pt-2">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-xs font-bold text-slate-950">
                  Verified school setup
                </h4>
                <p className="text-[10px] text-slate-500 mt-0.5 leading-relaxed">
                  We check registration details and structure configurations
                  before system handoff.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-500 mt-0.5 leading-relaxed">
                  Our rollout team reviews classes, fee structures, roles, and
                  agreed data-import needs.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-xs font-bold text-slate-950">
                  Role-aware school access
                </h4>
                <p className="text-[10px] text-slate-500 mt-0.5 leading-relaxed">
                  Admins, teachers, accountants, and coordinators access
                  customized layouts.
                </p>
              </div>
            </div>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-5 space-y-4">
            ...
            <div className="relative pl-6 space-y-4 text-[11px] font-bold text-slate-650">
              ...
              <div className="relative flex gap-3 items-center">
                <span className="absolute -left-[23px] h-5 w-5 rounded-full bg-blue-600 border border-blue-600 text-white font-extrabold flex items-center justify-center text-[9px] shrink-0 ring-4 ring-white">
                  1
                </span>
                <span>Submit request</span>
              </div>
              <div className="relative flex gap-3 items-center">
                <span className="absolute -left-[23px] h-5 w-5 rounded-full bg-slate-100 border border-slate-200 text-slate-500 font-extrabold flex items-center justify-center text-[9px] shrink-0 ring-4 ring-white">
                  2
                </span>
