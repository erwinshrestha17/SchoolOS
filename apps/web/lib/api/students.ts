...
export const studentsApi = {
  ...
  removeStudentGuardianAccess: (studentId: string, guardianId: string, body: { reason: string; confirmFileAccessReview: true }) => request<{ removed: true }>(`/admissions/m1/students/${encodeURIComponent(studentId)}/guardians/${encodeURIComponent(guardianId)}`, { method: 'DELETE', json: body }),
