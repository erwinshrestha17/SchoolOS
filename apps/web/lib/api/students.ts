...
export const studentsApi = {
  ...
  updateAdmissionApplicationStatus: (
    ...
    body: { status: LegacyAdmissionApplicationStatus; reason?: string },
  ) =>
  ...
  getStudentLifecycleTimeline: (studentId: string) =>
    request<any[]>(
      `/students/${encodeURIComponent(studentId)}/lifecycle-timeline`,
    ),
  ...
  reopenDuplicateStudentReview: (
    reviewId: string,
    body: ReopenDuplicateStudentReviewPayload,
  ) =>
  ...
  removeStudentGuardianAccess: (
    studentId: string,
    guardianId: string,
    body: RemoveStudentGuardianPayload,
  ) =>
