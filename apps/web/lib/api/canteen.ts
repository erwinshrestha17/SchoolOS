...
export const canteenApi = {
  listMenuItems: (params?: {
    ...
    request<CanteenMenuItem[]>(withQuery('/canteen/menu-items', params ?? {})),
  ...
  listMealPlans: (params?: { q?: string | null; status?: string | null }) =>
    request<CanteenMealPlan[]>(withQuery('/canteen/meal-plans', params ?? {})),
  ...
  getPosReceipt: (saleId: string) =>
    request<CanteenPosReceipt>(
      `/canteen/pos-sales/${encodeURIComponent(saleId)}/receipt`,
    ),
  openPosReceiptPdf: async (saleId: string) => {
    const response = await fetch(
      `${API_BASE_URL}/canteen/pos-sales/${encodeURIComponent(saleId)}/receipt.pdf`,
      { credentials: 'include' },
    );
  ...
  downloadItemWiseSalesCsv: (params?: {
    from?: string | null;
    to?: string | null;
  }) =>
    downloadCsv(
  ...
  getStockLedger: (params?: {
    ...
    request<CanteenStockLedgerRow[]>(
      withQuery('/canteen/reports/stock-ledger', params ?? {}),
    ),
};
