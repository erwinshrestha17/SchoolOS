...
export function StaffDashboard() {
  ...
  if (!profile) {
    ...
    const primaryRole =
      session?.user.roles[0]?.replace(/_/g, " ") ?? "Administrator";
          ...
          <div className="flex-1 space-y-6 w-full">
            <Card className="shell-card">
              <CardHeader>
                ...
                <CardDescription>
                  You are logged in with administrative roles. This account does
                  not have a linked payroll or timetable staff record.
                </CardDescription>
              </CardHeader>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {session?.user.roles.map((role) => (
                      <Badge
                        key={role}
                        className="bg-slate-100 text-slate-700 border border-slate-200 capitalize py-1 px-2.5"
                      >
                        {role.replace(/_/g, " ")}
                      </Badge>
                    ))}
            ...
            <TabsContent value="overview" className="mt-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      ...
                      <p className="text-sm">
                        ...
                        {maskStaffBankAccount(profile.bankAccount)}
                      </p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      Check the tabs for detailed attendance and payslip
                      history.
                    </p>
                  </CardContent>
                </Card>
