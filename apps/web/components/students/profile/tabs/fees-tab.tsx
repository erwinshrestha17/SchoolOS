        ...
        <SectionCard title="Fee Status" className="lg:col-span-1">
          <div className="space-y-6">
            <div className="flex items-end gap-2">
              ...
              <span className="mb-1 text-xs font-bold text-slate-400 uppercase tracking-wider">
                Balance Due
              </span>
            </div>
          ...
          {invoices.length > 0 ? (
            <div className="divide-y divide-slate-100">
              {invoices.map((invoice) => (
                <div
                  key={invoice.id}
                  className="flex flex-col gap-4 p-5 sm:flex-row sm:items-center sm:justify-between transition hover:bg-slate-50/50"
                >
