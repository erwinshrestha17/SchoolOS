...
export function SalaryStructureList() {
  ...
  const columns: PaginatedDataTableColumn<SalaryStructureRow>[] = [
    {
      id: 'staff',
      header: 'Staff',
      cell: (structure) => (
  ...
  return (
    <PaginatedDataTable
      ...
      errorMessage="Salary structures could not load. Please try again."
      emptyTitle="No salary structures defined yet"
      emptyDescription="Create a salary structure for a staff member to get started."
