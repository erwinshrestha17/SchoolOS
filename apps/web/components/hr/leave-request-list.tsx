      ...
      <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
        {leaveRequestsQuery.isLoading ? (
          ...
          filteredRequests.map((request) => (
            <div
              key={request.id}
              className="shell-card group flex flex-col rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:border-[var(--color-mod-hr-border)] hover:shadow-md"
            >
              ...
              <div className="mt-5 px-1">
                ...
                <p className="mt-2 text-sm font-medium text-slate-600 leading-relaxed line-clamp-2 italic">
