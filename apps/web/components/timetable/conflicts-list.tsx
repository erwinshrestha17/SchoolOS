  ...
  if (!activeVersionId) {
    return (
      <EmptyState
        ...
        description="Select or create a timetable version to run conflict validation."
      />
    );
  }

  if (validateQuery.isLoading)
    return <LoadingState label="Running conflict validation..." />;
      ...
      <div className="flex justify-between items-center">
        <div className="flex flex-col">
          ...
          <p className="text-sm text-slate-500 font-medium">
            Real-time validation against teacher availability, room capacity,
            and workload limits.
          </p>
        </div>
        <Button
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {error.conflictingSlotId && (
                      <Badge
                        variant="outline"
                        className="bg-white border-red-200 text-red-600 text-[10px] font-bold"
                      >
