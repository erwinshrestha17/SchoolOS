...
export function AttendanceAnalytics({
  ...
  const anomalyCounts = {
    ...
    unsubmittedWorkingDays:
      anomalies?.anomalies.unsubmittedWorkingDays.length ?? 0,
  };
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        >
          <div className="space-y-4">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[0.7rem] text-slate-500 uppercase tracking-wider font-bold">
                      Total Absences
                    </p>
                  </div>
                </div>
            ...
            {(!analytics.absenceHotlist ||
              analytics.absenceHotlist.length === 0) && (
        ...
        >
          <div className="space-y-4">
            ...
            {(!analytics.below80Warnings ||
              analytics.below80Warnings.length === 0) && (
              <p className="text-sm text-slate-500 text-center py-4">
      ...
      >
        {isLoadingAnomalies ? (
          ...
          <p className="py-4 text-center text-sm text-slate-500">
            No attendance anomalies detected in the current review window.
          </p>
        ) : (
          <div className="grid gap-4 lg:grid-cols-2">
            <AnomalyList
              ...
              rows={
                anomalies?.absenceStreaks.slice(0, 5).map((item) => ({
                  key: item.studentId,
            ...
            <AnomalyList
              ...
              rows={
                anomalies?.repeatedLates.slice(0, 5).map((item) => ({
                  key: item.studentId,
                  title: item.studentName,
            ...
            <AnomalyList
              ...
              rows={
                anomalies?.anomalies.rosterDivergences
                  .slice(0, 5)
                  .map((item) => ({
                    key: item.sessionId,
            ...
            <AnomalyList
              ...
              rows={
                anomalies?.anomalies.lateSubmissions
                  .slice(0, 5)
                  .map((item) => ({
                    key: item.sessionId,
                    title: classSectionLabel(item.className, item.sectionName),
