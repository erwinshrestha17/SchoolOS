        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-2">
            ...
            <select
              ...
              onChange={(e) =>
                setFilters((c) => ({ ...c, examTermId: e.target.value }))
              }
          ...
          <div className="p-4 rounded-2xl border border-[var(--color-mod-academics-border)] bg-[var(--color-mod-academics-surface)] flex items-center gap-4">
            ...
            <div>
              <p className="text-[10px] font-black text-[var(--color-mod-academics-accent)] uppercase tracking-widest">
                Locked Terms
              </p>
              <p className="text-xl font-black text-[var(--color-mod-academics-text)] tracking-tight">
      ...
      <div className="grid gap-10 lg:grid-cols-2">
        ...
        <section className="group relative rounded-2xl border border-slate-200 bg-white p-8 transition-all hover:border-[var(--color-mod-academics-border)] hover:shadow-sm overflow-hidden">
          ...
          <div className="space-y-4">
            <select
              ...
              onChange={(e) =>
                setRequestForm((c) => ({ ...c, examTermId: e.target.value }))
              }
            ...
            {selectedRequestExam && (
              ...
              >
                ...
                <span className="text-[10px] font-black uppercase tracking-widest">
                  Currently {selectedRequestExam.isLocked ? 'Locked' : 'Open'}
                </span>
              </div>
            )}
            ...
            <textarea
              ...
              onChange={(e) =>
                setRequestForm((c) => ({ ...c, reason: e.target.value }))
              }
        ...
        <section className="group relative rounded-2xl border border-slate-200 bg-white p-8 transition-all hover:border-amber-200 hover:shadow-sm overflow-hidden">
          ...
          <div className="mb-8">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Reopen a locked exam term (authorized only).
            </p>
          </div>
          ...
          <div className="space-y-4">
            <select
              ...
              onChange={(e) =>
                setUnlockForm((c) => ({ ...c, examTermId: e.target.value }))
              }
              className="premium-input bg-slate-50"
            >
            ...
            <textarea
              ...
              onChange={(e) =>
                setUnlockForm((c) => ({ ...c, reason: e.target.value }))
              }
        ...
        <div className="p-8 grid gap-6">
          {requestsQuery.isLoading ? (
            ...
            (requestsQuery.data ?? []).map((request) => (
              <article
                key={request.id}
                className="group relative rounded-2xl border border-slate-100 bg-white p-6 transition-all hover:border-[var(--color-mod-academics-border)] hover:shadow-sm"
              >
                <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                  ...
                  {(request.reviewNote || request.reviewedAt) && (
                    <div className="w-full lg:w-[240px] p-4 rounded-2xl bg-indigo-50/50 border border-indigo-100">
                      <p className="text-[8px] font-black text-indigo-400 uppercase tracking-widest mb-2">
                        Review Feedback
                      </p>
                      {request.reviewNote && (
                      ...
                      <div className="mt-2 flex flex-col gap-1">
                        <span className="text-[8px] font-bold text-slate-400 uppercase tracking-widest">
                          By {actorLabel(request.reviewedBy)}
                        </span>
