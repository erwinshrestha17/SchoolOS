      ...
      <DialogContent className="max-w-3xl overflow-hidden flex flex-col max-h-[90vh]">
          ...
          <div className="flex items-center justify-between pr-8">
            <div className="space-y-1">
              ...
              <p className="text-sm text-slate-500 font-medium">
                Posted on {formatBsDate(entry.entryDate)} • {entry.sourceType}
              </p>
            </div>
        ...
        <div className="flex-1 overflow-y-auto py-6 space-y-6">
              ...
              <div className="flex gap-3 mb-4">
                ...
                <div>
                  ...
                  >
                    ...
                    action will create a new balancing transaction. A clear
                ...
                <button
                  onClick={() =>
                    isReversing
                      ...
                      : correctMutation.mutate(entry.id)
                  }
                  disabled={
                    !reason.trim() ||
          ...
          <div className="rounded-2xl bg-[var(--color-mod-accounting-bg)] p-4 border border-[var(--color-mod-accounting-border)]">
            <p className="text-xs font-bold text-[var(--color-mod-accounting-text)] uppercase tracking-widest mb-1">
              Narration
            </p>
