      ...
      <div className="space-y-8">
        ...
        {duesQuery.data?.summary && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <SummaryStat
              label="Visible Page Billing"
              value={duesQuery.data.summary.totalBilled}
            />
            <SummaryStat
              label="Visible Page Waivers"
              value={duesQuery.data.summary.totalWaived}
              color="text-emerald-600"
            />
            <SummaryStat
              label="Visible Page Outstanding"
              value={duesQuery.data.summary.totalOutstanding}
