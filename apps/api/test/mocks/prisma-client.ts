...
export const AttendanceStatus = {
  ...
  EARLY_AUTHORIZED_DEPARTURE: 'EARLY_AUTHORIZED_DEPARTURE',
  UNAUTHORIZED_DEPARTURE: 'UNAUTHORIZED_DEPARTURE',
...
export const ActivityCategory = {
  ...
  SPORTS: 'SPORTS',
  GENERAL: 'GENERAL',
  CLASSROOM_LEARNING: 'CLASSROOM_LEARNING',
  MUSIC_AND_DANCE: 'MUSIC_AND_DANCE',
  SCIENCE_AND_PRACTICAL: 'SCIENCE_AND_PRACTICAL',
  ...
  FESTIVAL_AND_CULTURE: 'FESTIVAL_AND_CULTURE',
...
export const NotificationEventType = {
  ...
  ADMISSION_DOCUMENTS_REQUESTED: 'ADMISSION_DOCUMENTS_REQUESTED',
  ATTENDANCE_STUDENT_ABSENT: 'ATTENDANCE_STUDENT_ABSENT',
  ATTENDANCE_STUDENT_LATE: 'ATTENDANCE_STUDENT_LATE',
  ATTENDANCE_STUDENT_LEAVE: 'ATTENDANCE_STUDENT_LEAVE',
  ATTENDANCE_STUDENT_CONSECUTIVE_ABSENCE:
    'ATTENDANCE_STUDENT_CONSECUTIVE_ABSENCE',
  FEE_PAYMENT_CONFIRMED: 'FEE_PAYMENT_CONFIRMED',
  NOTICE_PUBLISHED: 'NOTICE_PUBLISHED',
  NOTICE_ACKNOWLEDGEMENT_FOLLOW_UP: 'NOTICE_ACKNOWLEDGEMENT_FOLLOW_UP',
} as const;

export const NotificationEventPriority = {
  NORMAL: 'NORMAL',
  IMPORTANT: 'IMPORTANT',
  CRITICAL: 'CRITICAL',
  MANDATORY: 'MANDATORY',
...
export const HomeworkSubmissionMethod = {
  PHYSICAL_NOTEBOOK: 'PHYSICAL_NOTEBOOK',
  CLASSWORK_COPY: 'CLASSWORK_COPY',
  PROJECT_FILE: 'PROJECT_FILE',
  ORAL_PREPARATION: 'ORAL_PREPARATION',
  MEMORIZATION: 'MEMORIZATION',
  ONLINE_ATTACHMENT: 'ONLINE_ATTACHMENT',
...
export const PayrollExceptionSeverity = {
  BLOCKING: 'BLOCKING',
  WARNING: 'WARNING',
  INFO: 'INFO',
} as const;

export const PayrollExceptionStatus = {
  OPEN: 'OPEN',
...
export const PayrollExceptionCode = {
  MISSING_SALARY_STRUCTURE: 'MISSING_SALARY_STRUCTURE',
  NO_EFFECTIVE_SALARY_STRUCTURE: 'NO_EFFECTIVE_SALARY_STRUCTURE',
  MISSING_ACTIVE_CONTRACT: 'MISSING_ACTIVE_CONTRACT',
  EXPIRED_CONTRACT: 'EXPIRED_CONTRACT',
  INACTIVE_STAFF_INCLUDED: 'INACTIVE_STAFF_INCLUDED',
