...
export function normalizeM9SourceModule(value: string) {
  ...
  if (!(M9_ACCOUNTING_SOURCE_MODULES as readonly string[]).includes(normalized)) {
...
export const NEPAL_SCHOOL_CHART_TEMPLATE: Array<{
  ...
  { code: '1020', name: 'Digital Payment Clearing', type: ChartAccountType.ASSET },
  { code: '1200', name: 'Student Fee Receivables', type: ChartAccountType.ASSET },
  ...
  { code: '2230', name: 'Tax Payable Placeholder', type: ChartAccountType.LIABILITY },
  { code: '2400', name: 'Canteen Wallet Liability', type: ChartAccountType.LIABILITY },
  { code: '3000', name: 'Opening Fund Balance', type: ChartAccountType.EQUITY },
  { code: '3100', name: 'Accumulated Surplus or Deficit', type: ChartAccountType.EQUITY },
  { code: '4000', name: 'Tuition Fee Income', type: ChartAccountType.REVENUE },
  { code: '4010', name: 'Admission Fee Income', type: ChartAccountType.REVENUE },
  { code: '4020', name: 'Exam Fee Income', type: ChartAccountType.REVENUE },
  { code: '4030', name: 'Transport Fee Income', type: ChartAccountType.REVENUE },
  { code: '4040', name: 'Library Fine and Replacement Income', type: ChartAccountType.REVENUE },
  { code: '4050', name: 'Canteen and Meal Income', type: ChartAccountType.REVENUE },
  { code: '5010', name: 'Salary Expense', type: ChartAccountType.EXPENSE },
  { code: '5200', name: 'Canteen Inventory Purchase Expense', type: ChartAccountType.EXPENSE },
  { code: '5300', name: 'Transport Fuel and Maintenance Expense', type: ChartAccountType.EXPENSE },
];
