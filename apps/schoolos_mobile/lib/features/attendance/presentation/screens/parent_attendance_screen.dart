...
class ParentAttendanceScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final effectiveStudentId = studentId == 'selected-child'
        ? (ref.watch(parentControllerProvider).selectedChildId ?? 'child-aarav')
        : studentId;
    final attendance = ref.watch(parentAttendanceProvider(effectiveStudentId));
    ...
    return RoleShellScaffold(
      ...
      body: attendance.when(
        ...
        error: (_, _) => AppErrorView(
          ...
          onRetry: () =>
              ref.invalidate(parentAttendanceProvider(effectiveStudentId)),
        ),
        data: (data) => RefreshIndicator(
          ...
          child: ListView(
            ...
            children: [
              ...
              DashboardCard(
                title: 'Today',
                value: data.summary.todayStatus.label,
