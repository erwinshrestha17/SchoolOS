...
export type StudentLifecycleStatus = "ACTIVE" | "TRANSFERRED" | "EXITED" | "ALUMNI" | "DELETED";
...
export type GuardianIdentityVerificationStatus = "PENDING" | "VERIFIED" | "REJECTED" | "REVOKED";
...
export type AttendanceAnalytics = {
    ...
    latestSessions: Array<AttendanceSummary & {
        conflictStatus: string;
        calendarDay?: AttendanceCalendarDayView;
    }>;
    classHeatmap: Array<{
...
export type TenantSettingKey = 'school_logo' | 'branding_primary_color' | 'timezone' | 'currency' | 'date_format' | 'attendance_lock_hours' | 'receipt_format' | 'fee_reminder_days' | 'sms_provider' | 'feature_toggles';
