export const permissionCatalog = [
  ...
  { resource: 'students', action: 'manage_lifecycle', description: 'Transfer, exit, archive, and manage student lifecycle transitions' },
  ...
  { resource: 'payments', action: 'refund', description: 'Refund collected payments with immutable journal posting' },
  { resource: 'payments', action: 'close', description: 'Preview and finalize cashier close snapshots' },
