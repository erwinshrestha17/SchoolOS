export const permissionCatalog = [
  ...
  { resource: 'homework', action: 'read', description: 'Read homework assignments and submissions' },
  { resource: 'homework', action: 'review', description: 'Review homework submissions and scores' },
  { resource: 'hr', action: 'manage', description: 'Manage HR contracts and staff employment records' },
  { resource: 'hr', action: 'read', description: 'Read HR contracts and staff employment records' },
  { resource: 'payroll', action: 'manage', description: 'Run, approve, and post payroll' },
  { resource: 'payroll', action: 'read', description: 'Read payroll runs and payslips' },
  ...
  { resource: 'fees', action: 'adjust', description: 'Void invoices and post audited fee invoice adjustments' },
  ...
  { resource: 'accounting', action: 'read', description: 'Read accounting periods and financial reports' },
  { resource: 'accounting', action: 'close', description: 'Close accounting periods with audit visibility' },
  { resource: 'accounting', action: 'reverse', description: 'Create reversing journal entries for posted accounting records' },
