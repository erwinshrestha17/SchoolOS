export const permissionCatalog = [
  ...
  ...[
    ...
    ["accounting:fiscal", "reopen", "Reopen closed fiscal periods"],
    ["accounting:journals", "read", "Read journal entries"],
    ["accounting:journals", "create", "Create manual journals"],
    ["accounting:journals", "submit", "Submit journals for approval"],
    ["accounting:journals", "approve", "Approve submitted journals"],
    ["accounting:journals", "reject", "Reject submitted journals"],
    ["accounting:journals", "post", "Post approved journals to ledger"],
    ["accounting:journals", "cancel", "Cancel draft or submitted journals"],
    ["accounting:journals", "reverse", "Reverse or correct journals"],
    ["accounting:reports", "read", "Read accounting reports"],
    ["accounting:reports", "trial-balance", "View Trial Balance report"],
    ["accounting:reports", "general-ledger", "View General Ledger report"],
    ["accounting:reports", "cash-book", "View Cash Book report"],
    ["accounting:reports", "income-statement", "View Income Statement report"],
